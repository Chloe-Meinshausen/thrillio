...
public class View {
	...
	public static void browse(User user, Bookmark[][] bookmarks) {
		...
		for (Bookmark[] bookmarkList : bookmarks) {
			for (Bookmark bookmark : bookmarkList) {
				...
				if (user.getType().equals(UserType.EDITOR) || user.getType().equals(UserType.CHIEF_EDITOR)) {
	...
	//TODO: below methods shouldsimulate user input. After IO , we take input from console
